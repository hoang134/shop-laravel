        ...
        <div class="container">
                    ...
                    <div class="row">
                        <div class="breadcrumbs col-sm-12 col-md-6 col-lg-6">
                            <ul>
                                ...
                                <li><a class="active" href="javascript:void(0)">@lang('labels.general.search')</a></li>
                            </ul>
                        </div>
                        <div class="order-category col-sm-12 col-md-6 col-lg-6">
                            <select id="sort">
                                <option {{ isset(request()->sort) ? request()->sort == 'default' ? 'selected' : '' : '' }} data-href="{{ route('search', ['keyword' => request()->keyword, 'sort' => 'default']) }}">@lang('labels.sort.default')</option>
                                <option {{ isset(request()->sort) ? request()->sort == 'asc' ? 'selected' : '' : '' }} data-href="{{ route('search', ['keyword' => request()->keyword, 'sort' => 'asc']) }}">@lang('labels.sort.low_to_high')</option>
                                <option {{ isset(request()->sort) ? request()->sort == 'desc' ? 'selected' : '' : '' }} data-href="{{ route('search', ['keyword' => request()->keyword, 'sort' => 'desc']) }}">@lang('labels.sort.high_to_low')</option>
                            </select>
                        </div>
                    </div>
                </div>
            ...
            <div class="category-product">
                <div class="col-12 title-more">
                    <div class="page-catelogy-title">
                        <div class="page-catelogy-title-left">
                            <h1>@lang('labels.general.search')</h1>
                        </div>
                ...
                <div class="des-cate col-12">
                    <p>{{ __('labels.general.result_search', ['keyword' => request()->keyword]) }}</p>
                </div>
                        ...
                        <div class="row">
                            ...
                            @else
                                @foreach($products as $product)
                                    <div class="col-item col-sm-12 col-md-4 col-lg-3">
