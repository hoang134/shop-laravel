<form class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
    <div class="col-md-12">
        <div class="form-group {{ $errors->first('title') ? 'has-error' : '' }} ">
            ...
            <input id="title" type="text" class="form-control"  placeholder="@lang('labels.post.title')" name="title" value="{{old('title', isset($page->title) ? $page->title : '')}}">
        ...
        <div class="form-group {{ $errors->first('url_image') ? 'has-error' : '' }} ">
            ...
            @if(isset($page->url_image))
                <img src="{{ $page->url_image }}" alt="" width="100px" style="margin-top: 0.1em">
            @endif
        ...
        <div class="form-group {{ $errors->first('description') ? 'has-error' : '' }} ">
            ...
            >{{old('description', isset($page->description) ? $page->description : '')}}</textarea>
        ...
        <div class="form-group {{ $errors->first('content') ? 'has-error' : '' }}">
            ...
            <textarea name="content" style="resize:vertical" class="form-control" id="content">{{ old('content', isset($page->content) ? $page->content : '') }}</textarea>
    ...
    <div class="col-md-12">
        <div class="form-group">
            <div class="col-sm-12 text-center">
                ...
                <a href="{{ route('pages.index') }}"  class="btn btn-danger with-btn mg-r-5"><i class="fa fa-fw fa-reply-all"></i>@lang('labels.general.back')</a>
